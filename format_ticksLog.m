...
%           03/25/2014: Modified by Jin Dai
%                       change offset into [offsetx offsety];
%                       
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [hx,hy] = ...
    format_ticksLog(h,tickx,ticky,tickposx,tickposy,rotx,roty,offset,varargin)
...
if rotx == 0;
    if latex_on;
        % modified by Jin Dai at 2014.07.31
        hx = text(tickposx,...
            repmat(lim(1)*offset(1), length(tickposx),1),...
            tickx,'HorizontalAlignment','center',...
            'VerticalAlignment','top','rotation',rotx,'interpreter','LaTex');
%         hx = text(tickposx,...
%             repmat(lim(1)-offset(1)*(lim(2)-lim(1)),length(tickposx),1),...
%             tickx,'HorizontalAlignment','center',...
%             'VerticalAlignment','top','rotation',rotx,'interpreter','LaTex');
    else;
        hx = text(tickposx,...
...
%    set(h,'XTick',tickposx);
    ...
    if roty == 0;
        if latex_on;
            hy = text(...
                repmat(lim(1)-offset(2)*(lim(2)-lim(1)),length(tickposy),1),...
                tickposy,...
