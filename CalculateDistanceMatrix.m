...
% Dimension check for Coords has been removed to adopt this function for hyper-distance calculation.
% So each row in Coords should represent one structure.
