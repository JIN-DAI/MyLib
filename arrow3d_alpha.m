function [h]=arrow3d_alpha(x,y,z,head_frac,radii,radii2,colr,alpha_value)
%
% The function plotting 3-dimensional arrow
%
% h=arrow3d_alpha(x,y,z,head_frac,radii,radii2,colr)
%
% The inputs are:
...
%
% example #1:
%        arrow3d_alpha([0 0],[0 0],[0 6],.5,3,4,[1 0 .5]);
% example #2:
%        arrow3d_alpha([2 0],[5 0],[0 -6],.2,3,5,'r');
% example #3:
%        h = arrow3d_alpha([1 0],[0 1],[-2 3],.8,3);
...
hidden off 
axis square
set(h,'FaceLighting','phong', 'BackFaceLighting','lit')
% camlight
