function arrowHandle = arrow3DMod(pos, deltaValues, colorCode, stemRatio, cRadiusRatio, cylinderRadius)

% arrowHandle = arrow3DMod(pos, deltaValues, colorCode, stemRatio, cRadiusRatio) %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    %******************************************* CYLINDER == STEM *********************************************
    if ~isempty(cRadiusRatio)
        cylinderRadius = cRadiusRatio*srho;
    end
